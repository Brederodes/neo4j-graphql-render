...
class PropertyFilter extends Filter_1.Filter {
    constructor({ attribute, relationship, comparisonValue, operator, attachedTo = "node", caseInsensitive = false, }) {
        super();
    ...
    createBaseOperation({ operator, property, param, }) {
        ...
        if (this.caseInsensitive) {
            ...
            if (operator === "IN") {
                const x = new cypher_builder_1.default.Variable();
                const lowercaseList = new cypher_builder_1.default.ListComprehension(x, param).map(cypher_builder_1.default.toLower(x));
                return cypher_builder_1.default.in(cypher_builder_1.default.toLower(coalesceProperty), lowercaseList);
            }
            return (0, create_comparison_operator_1.createComparisonOperation)({
                operator,
                property: cypher_builder_1.default.toLower(coalesceProperty),
                param: cypher_builder_1.default.toLower(param),
            });
        }
        else {
