        ...
        if (Object.keys(multiple_conditions_aggregation_map_1.multipleConditionsAggregationMap).includes(k)) {
            ...
            if (operator) {
                ...
                for (const [op, value] of Object.entries(v)) {
                    const checkFilterPasses = (0, get_filtering_fn_1.getFilteringFn)(op, operatorMapOverrides);
...
function shouldParseAsInt(attributeAdapter, value) {
